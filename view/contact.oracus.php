...
<div class="page-header">
				...
				<div class="col-md-4">
                    ...
                    <div class="contact-item wow fadeInUp" data-wow-delay="0.75s">
                        <div class="contact-content">
                            <div class="contact-content-title">
                                <h2>email us</h2>
                                <a href="mailto:contact@oracus.ng"><img src="<?php asset('images/icon-mail.svg') ?>" alt=""></a>
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="contact-details">
						...
						<div class="contact-detail-body">
							<p class="wow fadeInUp" data-wow-delay="0.25s">Ready to bring your ideas to life? Our team is here to help you tackle challenges, explore opportunities, and create amazing results. Let’s chat and see how we can make a difference together!</p>
							<h3 class="wow fadeInUp" data-wow-delay="0.5s">follow us:</h3>
							<ul class="wow fadeInUp" data-wow-delay="0.75s">
								<li><a href="https://facebook.com/oracusng/"><i class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="https://instagram.com/oracusng/"><i class="fa-brands fa-instagram"></i></a></li>
                                <li><a href="https://www.linkedin.com/company/oracus-ng"><i class="fa-brands fa-linkedin-in"></i></a></li>
	...
	<div class="google-map wow fadeInUp" data-wow-delay="0.25s">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126868.29328997571!2d7.4302343582650385!3d6.441002530459627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1044a3cf887d1a25%3A0x9e342e82908e0c3d!2sEnugu!5e0!3m2!1sen!2sng!4v1731154523919!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
	</div>
